...
The eval kept me honest. The headline number is 0.733 across 5 tasks at n=3 — not great, not bad. The change-flight chip scores 0/3 because Mia Li's prompt doesn't say which of her three reservations to modify; the agent investigates, asks for clarification, and my heuristic auto-confirmer can't pick a candidate. The cancel chip scores 2/3 because multi-turn auto-confirm reaches the mutate step most of the time. The other three pass 3/3 each. I could have tightened the change-flight prompt to lift the score. I left it ambiguous and documented the limitation on the page. Honest 0.733 reads better than inflated 0.95.
